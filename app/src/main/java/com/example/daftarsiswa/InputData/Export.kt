package com.example.daftarsiswa.InputData
...
//    }
//
//    private void runningReg(
//        final EditText email,
//        final EditText regPass,
//        final EditText regConfPass
//    ) {
...
//                "id",
//                ""
//            ) //id bersifat Auto_Increment tidak perlu diisi/(diisi NULL) cek create.php
//            .addBodyParameter(
//                "email",
//                email.getText().toString()
//            ) //mengirimkan data nama yang akan diisi dengan varibel nama
//            .addBodyParameter(
//                "password",
//                regPass.getText().toString()
//            ) //mengirimkan data agama yang akan diisi dengan varibel agama
